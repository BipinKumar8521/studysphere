...
export default async function Home() {
  ...
  const courses = [
    ...
    },
    {
      ...
      description: "Build dynamic web applications with React.js, including state management.",
      price: 50,
      instructor: "Asish Sir"
    },
    {
    ...
    },
    {
      ...
      subject: "TypeScript",
      description: "Learn TypeScript to enhance the development of scalable web applications.",
      price: 50,
      instructor: "Asish Sir"
    }
  ];
